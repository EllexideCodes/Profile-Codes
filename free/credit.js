$(document).ready(() => {
  ...
  console.log('%cIf you want to know more, go to https://www.themonster.xyz', 'color: #333; font-size: 3vh;font-family: Calibri;');
  var credit = $(`a[href="https://roleplay.chat/profile.php?user=Ellexide"]`);
  if(credit !== null || credit !== undefined) {
    credit.attr("href", "https://roleplay.chat/profile/php?user=Deum");
